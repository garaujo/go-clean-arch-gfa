...
func (_m *UserRepository) Fetch(limit int64) ([]domain.User, error) {
	ret := _m.Called(limit)
...
func (_m *UserRepository) GetByName(name string) (domain.User, error) {
	ret := _m.Called(name)
...
func (_m *UserRepository) Store(u *domain.User) error {
	ret := _m.Called(u)
...
func (_m *UserRepository) Update(u *domain.User) error {
	ret := _m.Called(u)
